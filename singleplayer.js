...
var audioClick = new Audio('msc/click.wav')         //som do click do botão
var audioEvol = new Audio('msc/evoluir.wav')        //som da evolução do persongem
var audioFim = new Audio('msc/fim.wav')
var audioWin = new Audio('msc/vitoria.wav')             //som do fim de jogo
var audioPok = new Audio('msc/pokebola.wav')

var imgPokInicial = "img/pichu.png"
var evol1 = "img/pikachu.png";
var evol2 = "img/pikachu2.png";
var evol1Talk = "img/pichuTalk.png";
var evol2Talk = "img/raichuTalk.png";
var poop = "img/pikachuM.png";
var ditto = "img/ditto.png" ;
...
function AtualizarTela(){                   //atualiza a posição dos personagens
    ...
    if(Encontrou(xHeroi,yHeroi)){  //caso o personagem for pego
        document.getElementById("btnMode").hidden = false;     
...
function Evolucao(numpokebola){              // 30 pokebolas = 1º evolução (pikachu)
    if(numpokebola == 30){                   // 50 pokebolas = 2º evolução (raichu)
        ...
        myTime = setTimeout(function(){  
            talk.style.opacity = "1";
            persTalk.src = evol1Talk;
            falaTalk.innerHTML = "Heyaaa"
        });
        myTime = setTimeout(function(){
            talk.style.opacity = "0";
        },6000)
        ...
        myTime = setTimeout(function(){  
            talk.style.opacity = "1";
            persTalk.src = evol2Talk;
            falaTalk.innerHTML = "Super Evolution!"
        });
        myTime = setTimeout(function(){
            talk.style.opacity = "0";
        },6000)
...
function Mode(btn){
    ...
    falaTalk = document.getElementById("fala");
    talk = document.getElementById("imgAnim");
    if(btn.innerHTML == "FOREST MODE")
    {
        document.body.style.backgroundImage = "url(img/background2.gif)"
        audioA = new Audio("msc/music2.mp3")  
        btn.innerHTML = "NORMAL MODE"
        imgPokInicial = "img/b.png"
        evol1 = "img/b2.png";
        evol2 = "img/b3.png";
        evol1Talk = "img/bTalk1.png";
        evol2Talk = "img/bTalk2.png";
        poop = "img/leef.png";
        ditto = "img/b4.png" ;
        pokebola.src =  "img/pokebola.png";
        imgMonstro1.src = "img/meowth.png";
        imgMonstro2.src = "img/meowth.png";
        imgMonstro3.src = "img/meowth.png";
        imgMonstro4.src = "img/meowth.png";
        imgFundo.src = "img/fundo2.jpg";
        objContexto.drawImage(imgFundo,0,0);
        document.getElementById("meuCanvas").style.border = "10px solid rgb(63 134 48)";

        clearTimeout(myTime);
        myTime = setTimeout(function(){  
            talk.style.opacity = "1";
            persTalk.src = "img/meowthTalk.png";
            falaTalk.innerHTML = "Do you want to fight??"
        });
        setTimeout(function(){
            talk.style.opacity = "0";
        },3000)
        ...
        audioA = new Audio("msc/sea.mp3")           
        btn.innerHTML = "FOREST MODE"
        imgPokInicial = "img/pichu.png"
        evol1 = "img/pikachu.png";
        evol2 = "img/pikachu2.png";
        evol1Talk = "img/pikachuTalk.png";
        evol2Talk = "img/raichuTalk.png";
        poop = "img/pikachuM.png";
        ditto = "img/ditto.png" ;
        pokebola.src =  "img/pokebola.png";
        imgMonstro1.src = "img/jessie.png";
        imgMonstro2.src = "img/james.png";
        ...
        imgFundo.src = "img/fundo.png";
        objContexto.drawImage(imgFundo,0,0);
        document.getElementById("meuCanvas").style.border = "10px solid rgb(81 164 207)";
        
        clearTimeout(myTime);
        myTime = setTimeout(function(){  
            talk.style.opacity = "1";
            persTalk.src = "img/teamrocketTalk2.png";
            falaTalk.innerHTML = "Do you want to fight??"
        });
        setTimeout(function(){
            talk.style.opacity = "0";
